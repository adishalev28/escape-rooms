...
// בועת המדריך (תוכי/רובוט/ינשוף) - אנגלית גדולה בקול, עברית קטנה מתחת
export default function GuideBubble({ bubble, emoji = '🦜' }) {
  if (!bubble) return null
  return (
    <div className="flex items-center gap-2.5" key={bubble.key}>
      <div className="text-4xl animate-floaty shrink-0">{emoji}</div>
